...
#' LEP <- MCMC_LEP(N = 1000, thin = 20, burn = 40, Time = cancer[,1],
#'                 Cens = cancer[,2], X = cancer[,3:11])
#' LEP.LML <- LML_LEP(thin = 20, Time = cancer[,1], Cens = cancer[,2],
...
#' @title Produce a trace plot of an observation's MCMC chain
...
Trace_Plot <- function(obs, chain){
    ...
    title <- paste("Trace Plot for Observation", obs)
